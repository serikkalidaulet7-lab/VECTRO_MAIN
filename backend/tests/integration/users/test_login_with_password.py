...
from app.modules.users.api.dependencies import get_access_token_issuer
...
from app.modules.users.infrastructure.security import Argon2PasswordHasher, JwtAccessTokenIssuer
...
def test_login_with_password_issues_verifiable_access_token(
    ...
    assert {"password", "password_hash", "refresh_token", "workspace_role"}.isdisjoint(body)
